...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/expdsv_semanal_$DATABACKUP.dmp full=y buffer=64000 consistent=y log=/pub/bkp_oracle/logico/expdsvapp1_semanal_$DATABACKUP.log
