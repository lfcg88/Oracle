...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/expdsvapp1_diario_$DATABACKUP.dmp full=y buffer=64000 consistent=y rows=y grants=y indexes=y statistics=none  log=/pub/bkp_oracle/logico/expdsvapp1_diario_$DATABACKUP.log
