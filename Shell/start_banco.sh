...
## -----------------------------------------------------------------------
## Habilita o Listener de comunicação no servidor Arsenio da instância oracle (orcl) de desenvolvimento
lsnrctl start 

## -----------------------------------------------------------------------
#  Linha de Comando que executa a Start da instância de Banco de Desenvolvimeto .
#
