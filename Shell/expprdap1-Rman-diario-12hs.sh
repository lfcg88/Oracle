...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/rman_prd_dia12hs_$DATABACKUP.dmp owner=rman buffer=64000 rows=y indexes=y statistics=none grants=y log=/pub/bkp_oracle/logico/rman_prd_dia12hs_$DATABACKUP.log
