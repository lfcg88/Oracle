...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/contbdeptst_diario_$DATABACKUP.dmp owner=contbdeptst buffer=64000 consistent=y rows=y grants=y indexes=y log=/pub/bkp_oracle/logico/contbdeptst_diario_$DATABACKUP.log
