...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/rman_diario_$DATABACKUP.dmp owner=rman statistics=none grants=y rows=y indexes=y buffer=64000 log=/pub/bkp_oracle/logico/contbdep_esquema_diario_$DATABACKUP.log
