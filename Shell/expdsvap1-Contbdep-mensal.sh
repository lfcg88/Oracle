...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/expdsvapp1_mensal_$DATABACKUP.dmp owner=contbdep_esquema buffer=64000 consistent=y grants=y  rows=y indexes=y statistics=none  log=/pub/bkp_oracle/logico/expdsvapp1_mensal_$DATABACKUP.log
