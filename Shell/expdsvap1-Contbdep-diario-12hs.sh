...
#
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/Contb_dsv_dia12hs_$DATABACKUP.dmp owner=contbdeptst buffer=64000 consistent=y grants=y rows=y indexes=y statistics=none  log=/pub/bkp_oracle/logico/Cont_dsv_dia12hs_$DATABACKUP.log
