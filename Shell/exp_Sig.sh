...
#  Variaveis de ambiente do ORACLE 9.2.0.8 no berilo.
#  Mayr 06/07/2007
#
...
/u01/app/oracle/product/9.2.0/bin/exp \'/ as sysdba\' file=/pub/bkp_oracle/logico/sig_jade.dmp owner=sig buffer=64000 consistent=y  rows=y indexes=y statistics=none  log=/pub/bkp_oracle/logico/sig_jade.log

exp leonel@bdepii file=/pub/bkp_oracle/logico/sig_jade.dmp owner=sig buffer=64000 consistent=y  rows=y indexes=y statistics=none  log=/pub/bkp_oracle/logico/sig_jade.log

## -----------------------------------------------------------------------
## Bloqueia login SYS as sysdba
