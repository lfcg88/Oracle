CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB9127 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB9127';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(832,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   SGPB0127(VAR_COMPT,PC_UTIL_01.Extra_Banco,'SGPB9127');
   --
END SGPB9127;
/
