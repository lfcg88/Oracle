create or replace procedure sgpb_proc.SGPB1200(
...
/*        SELECT 'competencia',
          ...
          WHERE ROC120.CCOMPT BETWEEN 200710 AND 200712
            AND ROC120.CCANAL_VDA_SEGUR = 2
            AND ROC120.CCPF_CNPJ_BASE = 7348888
            AND ROC120.CTPO_PSSOA = 'J'
            AND ROC120.CTPO_COMIS = 'CN'
            and ROC120.Cgrp_Ramo_Plano = '120'
         ORDER BY ROC120.CCOMPT;*/
  ...
  EXCEPTION
      WHEN OTHERS THEN
        ...
        PR_GRAVA_MSG_LOG_CARGA('SGPB1200',
                                   var_log_erro,
