CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB8015 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB8015';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(838,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   COMMIT;
   SGPB0015(VAR_COMPT,PC_UTIL_01.Finasa,'SGPB8015');
END SGPB8015;
/
