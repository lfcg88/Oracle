...
--      OBJETIVO        : CARGA MENSAL MARGEM CONTRIBUIÇÃO AGRUPAMENTO ECONÔMICO CORRETOR
--      ALTERAÇÕES      : 
--                DATA  : 28/02/2007 
...
/*---------------------------------------------------------------------------------------------*/
 ...
 EXCEPTION
     WHEN NO_DATA_FOUND THEN
          ...
          VAR_CSIT_CTRLM 	  		   := 5;               
          VAR_LOG  := 'ERRO NA SELEÇÃO DA COLUNA DINIC_AGPTO_ECONM_CRRTR NA TABELA SGPG.AGPTO_ECONM_CRRTR'||
