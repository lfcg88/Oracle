create or replace procedure sgpb_proc.SGPB6010_BKP is
------------------------------------------------------------------------------------------------------------------------
--  BRADESCO SEGUROS S.A.                                                                                           
--  DATA            : 11/10/2007
--  AUTOR           : ANDRE GUIMARÃES - VALUE TEAM                              
--  PROGRAMA        : SGPB6010.SQL                                                                             
--  OBJETIVO        : MANUTENÇÕES DW -- INSERE NAS TABELAS DE PARM_CARGA_DSTAQ
--  ALTERAÇÕES      :                                                                                               
--            DATA  : -                                                                                              
--            AUTOR : -                                                                                              
--            OBS   : -                                                                                              
...
VAR_CROTNA                  ARQ_TRAB.CROTNA%TYPE            := 'SGPB6010';
...
VAR_CPARM                   PARM_CARGA.CPARM%TYPE           := 758;     
...
BEGIN
    VAR_LOG := 'INSERE PARM_CARGA_DSTAQ';
    PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_PROCESSO, NULL, NULL);
    COMMIT;
    
    INSERT INTO parm_carga_dstaq
           (CPARM_CARGA_DSTAQ ,IPARM_CARGA_DSTAQ ,RPARM_CARGA_DSTAQ  ,DINCL_REG) 
    VALUES
           (1,'Bloqueio CNPJ','Tem como finalidade listar os CNPJ que estão bloqueados para a campanha em questão'
            ,TRUNC(SYSDATE));    
    INSERT INTO parm_carga_dstaq
           (CPARM_CARGA_DSTAQ ,IPARM_CARGA_DSTAQ ,RPARM_CARGA_DSTAQ  ,DINCL_REG) 
    VALUES
           (2,'Bloqueio Sucursal','Tem como finalidade listar as Sucursais que estão bloqueadas para a campanha em questão'
            ,TRUNC(SYSDATE));    
    INSERT INTO parm_carga_dstaq
           (CPARM_CARGA_DSTAQ ,IPARM_CARGA_DSTAQ ,RPARM_CARGA_DSTAQ  ,DINCL_REG) 
    VALUES
           (3,'Bloqueio CPD','Tem como finalidade listar os CPD´s que estão bloqueados para a campanha em questão'
            ,TRUNC(SYSDATE));    
