CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB6705 IS
-------------------------------------------------------------------------------------------------
...
--                        CANAL DE PRODUÇÃO 8 (FINASA)
--      ALTERAÇÕES      : 
--                DATA  : 16/04/2007
--                AUTOR : MONIQUE MARQUES - VALUE TEAM
--                OBS   : RETIRADA DA META DO RE PARA O CANAL FINASA
--
--                DATA  : 
--                AUTOR : 
--                OBS   : 
...
VAR_CROTNA                 	ARQ_TRAB.CROTNA%TYPE        	    := 'SGPB6705';
--
