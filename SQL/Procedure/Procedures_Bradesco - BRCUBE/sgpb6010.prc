create or replace procedure sgpb_proc.SGPB6010 is
------------------------------------------------------------------------------------------------------------------------
...
--  ALTERAÇÕES      : Acertos para campanha 3 , foi alterado VARIAVEIS DO PARAMETRO DE CARGA para 752  , realizado insert na tabela PARM_CARGA_DSTAQ                                                                                         
--            DATA  : 24/01/2008                                                                                             
...
BEGIN
    ...
    COMMIT;
            ...
            INSERT INTO PARM_CARGA_DSTAQ
                		...
                		DALT_REG)
            VALUES		(4,
             			'Valor da Meta Minima do Grupo Auto',
              			'Valor minimo de produção do Grupo Auto de uma Campanha',
               			SYSDATE,
                		NULL);
            			...
            			(CPARM_CARGA_DSTAQ,
             			IPARM_CARGA_DSTAQ,
              			RPARM_CARGA_DSTAQ,
               			DINCL_REG, DALT_REG)
            VALUES		(5,
            			'Valor da Meta Minima do Grupo RE',
              			'Valor minimo de produção do Grupo RE de uma Campanha',
               			SYSDATE,
               	 		NULL); 
