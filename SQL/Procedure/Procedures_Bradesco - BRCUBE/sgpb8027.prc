CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB8027 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB8027';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(841,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   COMMIT;
   SGPB0027(VAR_COMPT,Pc_Util_01.Finasa,VAR_ROTINA);
END SGPB8027;
/
