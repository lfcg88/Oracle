create or replace procedure sgpb_proc.SGPB6011_BKP is
------------------------------------------------------------------------------------------------------------------------
...
BEGIN
    ...
    INSERT INTO campa_parm_carga_dstaq
       (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA,CCONTD_PARM_CARGA,DINCL_REG)                                
    VALUES
           (1,1,'SGPB6011',846415,TRUNC(SYSDATE));    
    
    INSERT INTO campa_parm_carga_dstaq
       (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA,CCONTD_PARM_CARGA,DINCL_REG)                                
    VALUES
           (1,1,'SGPB6011',43338235,TRUNC(SYSDATE));  
           
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',2190592,TRUNC(SYSDATE));    
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',2519440,TRUNC(SYSDATE));    
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',30816391,TRUNC(SYSDATE));    
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',53215653,TRUNC(SYSDATE));    
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',59995639,TRUNC(SYSDATE)); 
         
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',63002745,TRUNC(SYSDATE));    
           
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',90251042,TRUNC(SYSDATE));    
           
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,1,'SGPB6011',2209148,TRUNC(SYSDATE));    
    
           
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,2,'SGPB6011',202,TRUNC(SYSDATE));       
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,3,'SGPB6011',33270315,TRUNC(SYSDATE));       
    
    INSERT INTO campa_parm_carga_dstaq
           (CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,IROTNA_ATULZ_PARM_CARGA  ,CCONTD_PARM_CARGA,DINCL_REG) 
    VALUES
           (1,3,'SGPB6011',899997,TRUNC(SYSDATE));       
