CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB0035
(
  tipo               NUMBER,
...
-------------------------------------------------------------------------------------------------
  ...
  --      OBJETIVO        : Sub-Procedure de SGPB0029. Insert em tabela temporaria liberados Pagamento
  --      ALTERA¿¿ES      :
  --                DATA  : -
  --                AUTOR : -
  --                OBS   : -
         ...
         ( --
          SELECT apc.ccanal_vda_segur,
           ...
           WHERE APC.CCOMPT_APURC < intCompTemp
             AND APC.CSIT_APURC in ('LM','BG') --APENAS LIBERADO MAS MENOR Q O MINIMO
