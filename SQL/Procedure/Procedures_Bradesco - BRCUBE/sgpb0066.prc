CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB0066 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB0066';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(843,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   COMMIT;
   SGPB0038(VAR_COMPT,PC_UTIL_01.Finasa,'SGPB0066');
END SGPB0066;
/
