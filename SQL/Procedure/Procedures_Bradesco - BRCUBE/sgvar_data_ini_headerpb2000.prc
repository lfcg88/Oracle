CREATE OR REPLACE PROCEDURE SGPB_PROC.SGVAR_DATA_INI_HEADERPB2000 IS
-------------------------------------------------------------------------------------------------
...
--        
   IF VAR_CAMBTE IN ('DESV', 'PROD') THEN
--   
      VAR_CSIT_CTRLM 	:= 6;
--      
...
--
      VAR_LOG := 'PROBLEMA AO CARREGAR CTPO_PSSOA_AGPTO_ECONM_CRRTR DO ARQUIVO.'||
                 ...
                 ' -- DINIC_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 241, 8)||                                  
                 ' -- ERRO ORACLE: '||SUBSTR(SQLERRM, 1, 120);
...
/*---------------------------------------------------------------------------------------------*/
 BEGIN
   WROW.IAGPTO_ECONM_CRRTR		:= SUBSTR(VAR_REGISTRO_ARQUIVO, 11, 30);
 EXCEPTION
   WHEN OTHERS THEN
--
...
--
      VAR_LOG := 'PROBLEMA AO CARREGAR IAGPTO_ECONM_CRRTR DO ARQUIVO.'||
                 ...
                 ' -- CCPF_CNPJ_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 2, 9)||
                 ' -- DINIC_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 241, 8)||
                 ' -- IAGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 11, 30)||                 
                 ' -- ERRO ORACLE: '||SUBSTR(SQLERRM, 1, 120);
      PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_DADO, NULL, NULL);
      --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));  
--
...
/*---------------------------------------------------------------------------------------------*/
 BEGIN
   WROW.RAGPTO_ECONM_CRRTR		:= SUBSTR(VAR_REGISTRO_ARQUIVO, 41, 200);
 EXCEPTION
   WHEN OTHERS THEN
--
...
--
      VAR_LOG := 'PROBLEMA AO CARREGAR RAGPTO_ECONM_CRRTR DO ARQUIVO.'||
                 ...
                 ' -- CCPF_CNPJ_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 2, 9)||
                 ' -- DINIC_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 241, 8)||
                 ' -- RAGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 41, 200)||                 
                 ' -- ERRO ORACLE: '||SUBSTR(SQLERRM, 1, 120);
      PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_DADO, NULL, NULL);
      --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));  
--
...
/*---------------------------------------------------------------------------------------------*/
 BEGIN
   WROW.DINIC_AGPTO_ECONM_CRRTR		:= TO_DATE(SUBSTR(VAR_REGISTRO_ARQUIVO, 241, 8),'DDMMYYYY');
 EXCEPTION
   WHEN OTHERS THEN
--
...
/*---------------------------------------------------------------------------------------------*/
 BEGIN
   WROW.CRESP_ULT_ALT		:= SUBSTR(VAR_REGISTRO_ARQUIVO, 249, 50);
 EXCEPTION
   WHEN OTHERS THEN
--
...
--
      VAR_LOG := 'PROBLEMA AO CARREGAR CRESP_ULT_ALT DO ARQUIVO.'||
                 ...
                 ' -- CCPF_CNPJ_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 2, 9)||
                 ' -- DINIC_AGPTO_ECONM_CRRTR: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 241, 8)||
                 ' -- CRESP_ULT_ALT: '||SUBSTR(VAR_REGISTRO_ARQUIVO, 249, 50)||                                  
                 ' -- ERRO ORACLE: '||SUBSTR(SQLERRM, 1, 120);
      PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_DADO, NULL, NULL);
      --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));  
--
...
--
      IF VAR_ERRO = 'S' THEN 
         VAR_TOT_REG_ERRO := VAR_TOT_REG_ERRO + 1;
      END IF;
--      
...
--   
        VAR_CSIT_CTRLM 	:= 6;
--  
        VAR_LOG := 'ERRO NO SUB-PROGRAMA DE CARGA DOS DADOS DA TABELA ' ||
                    VAR_TABELA||
                   ' -- ERRO ORACLE: '|| SUBSTR(SQLERRM, 1, 120);
	    PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_PROCESSO, NULL, NULL);
        --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));   
...
--
   ...
   --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));
--                   
   IF VAR_EXISTE_CTRLM_5 = TRUE THEN     
--                         
      RAISE VAR_FIM_PROCESSO_ERRO;
--
   ELSIF VAR_CSIT_CTRLM = 1 THEN 
      ...
      --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));   
--
      VAR_LOG := 'TOTAL DE REGISTROS PROCESSADOS COM ERRO NA EXTRAÇÃO PARA O NI: '||
                 TO_CHAR(VAR_TOT_REG_ERRO);
      PR_GRAVA_MSG_LOG_CARGA(VAR_CROTNA, VAR_LOG, VAR_LOG_PROCESSO, NULL, NULL);
      --DBMS_OUTPUT.PUT_LINE(SUBSTR(VAR_LOG,1,255));             
--                                   
