CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB6019_2 is
------------------------------------------------------------------------------------------------------------------------
--  BRADESCO SEGUROS S.A.
--  DATA            : 22/10/2007
--  AUTOR           : JOSEVALDO COUTINHO - VALUE TEAM
--  PROGRAMA        : SGPB6019.SQL
--  OBJETIVO        : APAGA TABELA META_RGNAL_DSTAQ
--  ALTERAÇÕES      :
--            DATA  : -
--            AUTOR : -
--            OBS   : -
...
VAR_CROTNA                  ARQ_TRAB.CROTNA%TYPE            := 'SGPB6019';
...
END TRATA_PARAMETRO;
/* ***************************************************************** */
------------- PROCEDURE APAGA TABELA META_RGNAL_DSTAQ ----------------------------
--
PROCEDURE EXEC_SCRIPT_META_RGNAL_DSTAQ IS
BEGIN
...
END EXEC_SCRIPT_META_RGNAL_DSTAQ;
