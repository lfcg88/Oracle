create or replace procedure sgpb_proc.SGPB6001_2 is
------------------------------------------------------------------------------------------------------------------------
...
BEGIN
    ...
    insert into grp_ramo_campa_dstaq
     ...
     values
       (2,'120',1,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'460',1,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'519',1,trunc(sysdate),trunc(sysdate));

    -- insere o grupo ramo 2 -- RE
    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'331',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'351',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'600',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'917',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'925',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'927',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'810',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'919',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'921',2,trunc(sysdate),trunc(sysdate));
    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'923',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'926',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'292',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'574',2,trunc(sysdate),trunc(sysdate));

    insert into grp_ramo_campa_dstaq
       (ccampa_dstaq,cramo,cgrp_ramo_dstaq,dincl_reg,dalt_reg)
     values
       (2,'613',2,trunc(sysdate),trunc(sysdate));
    COMMIT;
EXCEPTION
   WHEN OTHERS THEN
