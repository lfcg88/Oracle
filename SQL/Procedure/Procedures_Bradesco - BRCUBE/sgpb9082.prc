CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB9082 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB9082';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(845,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   SGPB0082(VAR_COMPT,Pc_Util_01.Banco,'SGPB9082');
