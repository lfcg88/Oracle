CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB9081 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB9081';
  VAR_COMPT                     number(6);
BEGIN
   ...
   PR_LE_PARAMETRO_CARGA(850,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   SGPB0081(VAR_COMPT,VAR_IDTRIO_TRAB,VAR_IARQ_TRAB,'SGPB9081');
