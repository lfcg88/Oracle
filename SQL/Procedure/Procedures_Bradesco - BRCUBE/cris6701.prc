CREATE OR REPLACE PROCEDURE SGPB_PROC.CRIS6701 IS
------------------------------------------------------------------------------------------------------------------------
...
BEGIN
       ...
       INSERT INTO CAMPA_PARM_CARGA_DSTAQ(CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,CCONTD_PARM_CARGA,IROTNA_ATULZ_PARM_CARGA,DINCL_REG,DALT_REG)
	                  VALUES(200802, 4, 30000, 'SGPB6701', SYSDATE, NULL);

       INSERT INTO CAMPA_PARM_CARGA_DSTAQ(CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,CCONTD_PARM_CARGA,IROTNA_ATULZ_PARM_CARGA,DINCL_REG,DALT_REG)
	                  VALUES(200802, 5, 9000, 'SGPB6701', SYSDATE, NULL);

        INSERT INTO CAMPA_PARM_CARGA_DSTAQ(CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,CCONTD_PARM_CARGA,IROTNA_ATULZ_PARM_CARGA,DINCL_REG,DALT_REG)
	                  VALUES(200802, 6, 20000, 'SGPB6701', SYSDATE, NULL);
        
        INSERT INTO CAMPA_PARM_CARGA_DSTAQ(CCAMPA_DSTAQ,CPARM_CARGA_DSTAQ,CCONTD_PARM_CARGA,IROTNA_ATULZ_PARM_CARGA,DINCL_REG,DALT_REG)
	                  VALUES(200802, 7, 12000, 'SGPB6701', SYSDATE, NULL);                   
