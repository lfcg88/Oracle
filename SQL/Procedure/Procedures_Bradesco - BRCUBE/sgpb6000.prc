create or replace procedure sgpb_proc.SGPB6000 is
------------------------------------------------------------------------------------------------------------------------
...
--  ALTERAÇÕES      :  FOI ADICIONADO UM NOVO INSERT , FOI ADICIONADO 752  PARA VARIAVEIS DO PARAMETRO DE CARGA   --                                                                                            
---            DATA  : 24/01/2008                                                                                             
...
BEGIN
    			UPDATE CAMPA_DSTAQ SET CIND_CUPOM_PROML = 'S', CIND_PRMIO_PCIAL = 'S', CIND_SITE_ATIVO = 'S'
				WHERE CCAMPA_DSTAQ = 1;
    ...
    COMMIT;
					...
					VALUES(
							3,
							'CAMPANHA DESTAQUE DA PRODUÇÃO AUTO RE',
							'N',
							7000,
							80,
							'S',
