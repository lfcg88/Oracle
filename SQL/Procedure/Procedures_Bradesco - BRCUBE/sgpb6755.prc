CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB6755 IS
-------------------------------------------------------------------------------------
--  BRADESCO SEGUROS S.A.                                                            
--  DATA            : 11/10/2007
--  AUTOR           : HUGO CARDOSO - VALUE TEAM
--  PROGRAMA        : SGPB6755_NIR.SQL                                                   
...
VAR_CROTNA          			ARQ_TRAB.CROTNA%TYPE  		   := 'SGPB6755';	-- parâmetro de rotina
---
-->> Variáveis para o parâmetro de carga
---
VAR_CPARM         			    PARM_CARGA.CPARM%TYPE    	   := 675;      -- parametro de carga para os dados da dimensão, atribuido aqui na inicialização
