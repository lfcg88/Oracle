CREATE OR REPLACE Procedure SGPB_PROC.SGPB6026 is
------------------------------------------------------------------------------------------------------------------------
--  BRADESCO SEGUROS S.A.                                                                                           
--  DATA            : 24/01/2008
--  AUTOR           : wellington P Medeiros - VALUE TEAM                              
--  PROGRAMA        : SGPB6026.SQL                                                                             
--  OBJETIVO        : CARGA DA PARM_HIERQ_DSTAQ 
--  ALTERAÇÕES      :                                                                                            
---           DATA  :                                                                                              
--            AUTOR :                                                                                             
--            OBS   : - -------------------------------------------------------------------------------------------------
...
VAR_CROTNA                  ARQ_TRAB.CROTNA%TYPE            := 'SGPB6026';
...
PROCEDURE CARGA_PARM_HIERQ_DSTAQ IS
BEGIN
    			   
    
    
    VAR_LOG := 'INSERE PARM_HIERQ_DSTAQ';      
    PR_GRAVA_MSG_LOG_CARGA( VAR_CROTNA,  VAR_LOG, VAR_LOG_PROCESSO,NULL,NULL);
    COMMIT;
			...
			INSERT INTO PARM_HIERQ_DSTAQ 
	   		...
	   		VALUES		(3,
	   		 			2,
	   		  			'META_DSTAQ',
	   		   			'CANAL/GRUPO_REGIONAL/REGIONAL/CNPJ',
	   		    		'S',
	   		    		SYSDATE,
	   		      		NULL);
			...
			INSERT INTO PARM_HIERQ_DSTAQ 
   			...
   			VALUES		(3,
   		 				6, 
   		 				'POSIC_DSTAQ',
   		  				'CANAL/GRUPO_REGIONAL/REGIONAL/SUCURSAL/CNPJ/SUCCPD',
   		   				'S', 
   		   				SYSDATE,
   		    			NULL);
