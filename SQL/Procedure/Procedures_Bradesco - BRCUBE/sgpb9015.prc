CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB9015 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB9015';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(837,VAR_DCARGA, VAR_DPROX_CARGA);   
   ...
   COMMIT;
   SGPB0015(VAR_COMPT,PC_UTIL_01.Banco,'SGPB9015');
END SGPB9015;
/
