CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB9080 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB9080';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(848,VAR_DCARGA, VAR_DPROX_CARGA);
