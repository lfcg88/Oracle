...
( Intrcompetencia  prod_crrtr.ccompt_prod%TYPE,
  ...
  --      OBJETIVO        : Procedure para deletar os corretores que estão impedidoS.
  --      ALTERAÇÕES      : Tratar Campanha Encerrada. Ass. Wassily ( 24/09/2007 )
  --                        Essa Rotina precisa "pegar" a DATA INICIO da campanha que está com DATA FIM igual a nula
     ...
     AND (Ccrrtr, Cund_Prod) IN
         (SELECT C.Ccrrtr, C.Cund_Prod
            ...
            JOIN parm_info_campa pic
             ...
             AND pic.DFIM_VGCIA_PARM is null -- pegando a campanha que não terminou.
