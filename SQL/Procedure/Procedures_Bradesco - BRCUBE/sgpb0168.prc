CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB0168
-------------------------------------------------------------------------------------------------
  --      BRADESCO SEGUROS S.A.
  --      PROCEDURE       : SGPB0168
  --      DATA            : 28/3/2007
  --      AUTOR           : Vinicius Faria - ANALISE E DESENVOLVIMENTO DE SISTEMAS
  --      OBJETIVO        : GERA O ARQUIVO DA PRODUC?O DOS CORRETORES ELEITOS - EXTRABANCO.
  --      ALTERAC?ES      : O HARD CODE FOI ALTERADO PARA GERAR A PRODUCAO DO TERCEIRO TRIMESTRE. ASS. WASSILY (27/06/2007) 
  --                DATA  : -
  --                AUTOR : -
  --                OBS   : -
  -------------------------------------------------------------------------------------------------
 IS
  ...
  BEGIN
    FOR c IN (SELECT cec.ccpf_cnpj_base,
                     cec.ctpo_pssoa,
                     cuc.iatual_crrtr,
                     cc.compt,
                     nvl(t.prod, 0) prod
