CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB8125 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB8125';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(831,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   COMMIT;
   SGPB0125(VAR_COMPT,Pc_Util_01.Finasa,'SGPB8125');  
END SGPB8125;
/
