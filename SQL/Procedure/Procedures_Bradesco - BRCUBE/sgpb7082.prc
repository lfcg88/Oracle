CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB7082 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB7082';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(847,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   SGPB0082(VAR_COMPT,Pc_Util_01.Extra_Banco,'SGPB7082');
