create or replace procedure sgpb_proc.SGPB6001 is
------------------------------------------------------------------------------------------------------------------------
...
--  ALTERAÇÕES      :  FOI ADICIONADO UM NOVO INSERT , FOI ADICIONADO 752  VARIAVEIS DO PARAMETRO DE CARGA   --                                                                                            
---            DATA  : 24/01/2008                                                                                             
...
BEGIN
    ...
    COMMIT;
  						...
  						SELECT 3 , CRAMO, CGRP_RAMO_DSTAQ, DINCL_REG, DALT_REG
 						FROM GRP_RAMO_CAMPA_DSTAQ WHERE CCAMPA_DSTAQ = 1);
