CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB7015 IS
  -------------------------------------------------------------------------------------------------
  ...
  VAR_ROTINA                    VARCHAR2(08) := 'SGPB7015';
...
BEGIN  
   ...
   PR_LE_PARAMETRO_CARGA(839,VAR_DCARGA, VAR_DPROX_CARGA);
   ...
   COMMIT;
   SGPB0015(VAR_COMPT,PC_UTIL_01.Extra_Banco,'SGPB7015');
END SGPB7015;
/
