create or replace procedure sgpb_proc.SGPB0151_producao(intrCodCanal  in CANAL_VDA_SEGUR.CCANAL_VDA_SEGUR %TYPE,
   ...
   PROCEDURE getTrimestre(PCodCanal    in CANAL_VDA_SEGUR.CCANAL_VDA_SEGUR %TYPE,
    ...
    EXCEPTION
     WHEN NO_DATA_FOUND THEN
          chrLocalErro := 11;
          PR_GRAVA_MSG_LOG_CARGA('SGPB0151','Cod.Erro: '||chrLocalErro ||' CPF_CNPJ: '||intrCPF_CNPJ||
...
BEGIN
    ...
    getTrimestre(intrCodCanal,intCpfCnpjBase, chrTpPessoa, VAR_TRIMESTRE);
