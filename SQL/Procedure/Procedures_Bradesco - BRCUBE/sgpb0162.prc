CREATE OR REPLACE PROCEDURE SGPB_PROC.SGPB0162(
  ...
  --      objetivo        : DAO para Relatório de bonificacao apolices - Producao extra-banco
  --      objetivo        :
  --      objetivo        :
  --      alterações      :
  --                data  : -
    ...
    SELECT 'tipoPessoa',
      ...
      join agpto_ramo_plano arp
       ...
       and arp.cramo           = aplc.cramo_apolc
        --
        --
     where aplc.ctpo_docto = p_ctpo_docto
