...
column Minuto         format a18
column Hit           format 999.99


select 
   to_char(snap_time,'dd/mm/yyyy:hh24mi') Minuto,
...
and 
    snap_time >= to_date('&vDataInicio','dd/mm/yyyy') and (snap_time - 1)  <= to_date('&vDataFim','dd/mm/yyyy') 
group by
   to_char(snap_time,'dd/mm/yyyy:hh24mi')
;
